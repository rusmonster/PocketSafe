...
public class SmsMainActivity extends CMBaseListActivity {
	...
	private String mThreadForDelName;
		...
		try {
			...
			switch (item.getItemId()) {
				...
				case R.id.mnuMainDelThread:
					mThreadForDelId = idx;
					mThreadForDelName = getNameByIndex(idx);
	...
	AlertDialog ShowDelThreadDialog(int idx) throws MyException {
		...
		String msg = getResources().getString(R.string.sms_delthreadconf, mThreadForDelName);
		dlg.setMessage(msg);
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		outState.putString("mainThreadForDelName", mThreadForDelName);
		outState.putInt("mainThreadForDelId", mThreadForDelId);
	...
	protected void onRestoreInstanceState(Bundle outState) {
		...
		mThreadForDelName = outState.getString("mainThreadForDelName");
		mThreadForDelId = outState.getInt("mainThreadForDelId");
